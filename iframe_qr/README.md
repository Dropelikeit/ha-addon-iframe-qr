...
3. Unter *Konfiguration* die `url` (Standard: `https://viewora.marcel-strahl.de`) und optional `qr_size` setzen. Mit `party_mode: true` wird ein rotierender Regenbogen-Rand mit Glow nach innen um den Bildschirmrand aktiviert.
